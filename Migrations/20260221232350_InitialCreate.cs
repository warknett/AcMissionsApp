    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MissionFactions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MissionFactions_Factions_FactionId",
                        column: x => x.FactionId,
                        principalTable: "Factions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MissionFactions_Missions_MissionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MissionFactions_FactionId",
                table: "MissionFactions",
                column: "FactionId");

            migrationBuilder.CreateIndex(
                name: "IX_MissionFactions_MissionId",
                table: "MissionFactions",
                column: "MissionId");
        }
